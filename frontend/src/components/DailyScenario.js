...
const DailyScenario = () => {
  ...
  useEffect(() => {
      ...
      if (savedApiKey) {
        ...
        const defaultApiKey = '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';
